...
def main(args):
    ...
    for epoch in range(args.epoch):
        ...
        # 计算分类指标
        all_metric_train = all_metric_cls(all_preds, all_labels, os.path.join(confusion_dir, f'train-{epoch}.png'), is_instance_only=False)
        ...
        with torch.no_grad():
            ...
            all_metric_eval = all_metric_cls(all_preds, all_labels, os.path.join(confusion_dir, f'eval-{epoch}.png'), is_instance_only=False)
