...
from torch import FloatTensor, cuda, LongTensor
...
class RandPointCNN(nn.Module):
    ...
    def __init__(self, C_in : int, C_out : int, dims : int, K : int, D : int, P : int,
        ...
        super().__init__()
        self.pointcnn = PointCNNEncoder(C_in, C_out, dims, K, D, P, r_indices_func)
        self.P = P
...
class PointCNN(nn.Module):
    ...
    def __init__(self, n_classes):
        ...
        self.fcn = nn.Sequential(
            ...
            Dense(64, n_classes, with_bn=False, activation=None)
        )
...
if __name__ == '__main__':
    atensor = torch.rand(5, 3, 2000).cuda()

    anet = PointCNN(20).cuda()
