...
class PointConv(torch.nn.Module):
	def __init__(self, num_classes=40, emb_dims=1024, input_shape="bnc", input_channel_dim=3, classifier=True, pretrained=None):
		super().__init__()
	...
	def forward(self, input_data):  # -> [bs, 3, n_points]
